...
public class TodoServiceImpl implements TodoService {
    ...
    public void addTodo(TodoRequest todo) {
      ...
      Todo todoToSave= Todo.builder().todoName(todo.todoName()).todoColor(todo.todoColor()).todoDescription(todo.todoDescription()).date(todo.date()).completed(todo.completed()).build();
      todoToSave.setTodoCategory(todoCategoryRepository.findTodoCategoryByCategoryName(todo.todoCategory()));
    ...
    public TodoResponse updateTodo(long todoId, TodoRequest todo) {
     ...
     if(optTodo.isPresent()){
         ...
         todoToUpdate.setTodoCategory(todoCategoryRepository.findTodoCategoryByCategoryName(todo.todoCategory()));
